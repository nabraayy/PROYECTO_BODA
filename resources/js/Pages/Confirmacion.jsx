...
export default function Confirmacion({ yaConfirmadoServer }) {
    // 1. Sincronización estricta: si el servidor dice que ya confirmó, bloqueamos.
    const [yaHaConfirmado, setYaHaConfirmado] = useState(yaConfirmadoServer);

    // 2. Este efecto es VITAL. Cuando haces el POST, el servidor vuelve a mandar las props.
    // Si yaConfirmadoServer cambia a true, este useEffect ocultará el formulario al instante.
    useEffect(() => {
    ...
    const submit = (e) => {
        ...
        post('/confirmar-asistencia', {
            preserveScroll: true,
            onSuccess: () => {
                // El servidor refrescará la prop 'yaConfirmadoServer' y el useEffect hará el resto
                reset();
        ...
        <>
            ...
            <section className="py-20 px-6 bg-gray-50/50">
                <div className="max-w-xl mx-auto">
                    ...
                    {/* --- LÓGICA DE BLOQUEO --- */}
                    {yaHaConfirmado ? (
                        /* VISTA DE ÉXITO: Se muestra si ya hay una confirmación en la DB */
                        ...
                        /* VISTA DEL FORMULARIO: Solo se muestra si NO hay confirmación */
                                ...
                                <div className="animate-in slide-in-from-top-4 duration-500">
                                    ...
                                    <div className="mb-6 p-4 bg-[#f9faf8] rounded-md border border-[#e8ede4]">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Escribe los nombres de las personas..."
                                            rows="2"
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <textarea
                                            ...
                                            rows="3"
                                            placeholder="Ej: Juan (Sin gluten)..."
